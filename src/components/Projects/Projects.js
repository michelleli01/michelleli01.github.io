            ...
            <Container className="project-heading">
                ...
                <Row style={{ justifyContent: "center", paddingBottom:"10px"}}>
                    ...
                    <Col md={4} className="project-card">
                        ...
                        img={paint}
                        title="Network Paint"
                        description="Used Java, GUIs, and Network Programming in order to create a painting program that allows clients to connect onto the same server and paint on the same canvas using unique colors"
